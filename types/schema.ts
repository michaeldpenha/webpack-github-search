...
export type IssueFieldsFragment = { __typename: 'Issue' } & Pick<
  Issue,
  'id' | 'number' | 'title' | 'body' | 'bodyHTML' | 'createdAt' | 'closed' | 'closedAt'
> & {
    author?: Maybe<
      | ({ __typename?: 'Bot' } & Pick<Bot, 'login' | 'avatarUrl'>)
      | ({ __typename?: 'EnterpriseUserAccount' } & Pick<
          EnterpriseUserAccount,
          'login' | 'avatarUrl'
        >)
      | ({ __typename?: 'Mannequin' } & Pick<Mannequin, 'login' | 'avatarUrl'>)
      | ({ __typename?: 'Organization' } & Pick<Organization, 'login' | 'avatarUrl'>)
      | ({ __typename?: 'User' } & Pick<User, 'login' | 'avatarUrl'>)
    >;
  };
...
export type CommentFieldsFragment = { __typename: 'IssueComment' } & Pick<
  IssueComment,
...
export type GetIssueDetailsQuery = { __typename?: 'Query' } & {
  repository?: Maybe<
    { __typename?: 'Repository' } & Pick<Repository, 'id' | 'name'> & {
        issue?: Maybe<
          { __typename?: 'Issue' } & {
            comments: { __typename?: 'IssueCommentConnection' } & Pick<
            ...
            > & {
                edges?: Maybe<
                  Array<
                    Maybe<
                      { __typename?: 'IssueCommentEdge' } & {
                        node?: Maybe<{ __typename?: 'IssueComment' } & CommentFieldsFragment>;
                      }
                    >
                  >
                >;
...
export const GetIssueDetailsDocument = gql`
...
/**
 * __useGetIssueDetailsQuery__
 *
 * To run a query within a React component, call `useGetIssueDetailsQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetIssueDetailsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetIssueDetailsQuery({
 *   variables: {
 *      name: // value for 'name'
 ...
 * });
 */
export function useGetIssueDetailsQuery(
  baseOptions: Apollo.QueryHookOptions<GetIssueDetailsQuery, GetIssueDetailsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<GetIssueDetailsQuery, GetIssueDetailsQueryVariables>(
    GetIssueDetailsDocument,
    options,
  );
}
export function useGetIssueDetailsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<GetIssueDetailsQuery, GetIssueDetailsQueryVariables>,
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<GetIssueDetailsQuery, GetIssueDetailsQueryVariables>(
    GetIssueDetailsDocument,
    options,
  );
}
export type GetIssueDetailsQueryHookResult = ReturnType<typeof useGetIssueDetailsQuery>;
export type GetIssueDetailsLazyQueryHookResult = ReturnType<typeof useGetIssueDetailsLazyQuery>;
export type GetIssueDetailsQueryResult = Apollo.QueryResult<
  GetIssueDetailsQuery,
  GetIssueDetailsQueryVariables
>;
